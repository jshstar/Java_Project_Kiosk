...
-------------------------------------------------------
주문 목록
1. ShackBurger     | W 6.9 | 3개 | 토마토, 양상추, 쉑소스가 토핑된 치즈버거
...
-------------------------------------------------------
```
부분 취소와 전부 취소가 표시되며 1번 부분취소를 입력시 선택한 물품 개수안에서 입력한 원하는 개수만큼 취소가능

```
-------------------------------------------------------
부분 취소를 선택하셨습니다 몇개를 취소하시겠습니까?
0: 돌아가기
-------------------------------------------------------
개수를 입력해주세요.
1
...
```
2번 입력
2번 입력후 왁인시 취소완료와 함께 메인메뉴로 돌아간다.
```
-------------------------------------------------------
1개 취소를 입력하셨습니다.
입력하시겠습니까?
...
-------------------------------------------------------
```
취소후 5번 Order을 통해 주문 취소 확인
```
-------------------------------------------------------
아래와 같이 주문 하시겠습니까?
[ Orders ]
ShackBurger     | W 6.9 | 2개 | 토마토, 양상추, 쉑소스가 토핑된 치즈버거
Shroom Burger   | W 9.4 | 1개 | 몬스터 치즈와 체다 치즈로 속을 채운 베지테리안 버거
Red Bean Shake  | W 6.5 | 1개 | 신선한 커스터드와 함께 우유와 레드빈이 블렌딩 된 시즈널 쉐이크
[ Total ]
W 29.7
